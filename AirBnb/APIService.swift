...
class APIService {
    ...
    func getCategories(competion: @escaping(CategoriesResponse?) -> ()){
        ...
        var demoResponse=CategoriesResponse(data:[DataModel( id: "Tag:8678",
    ...
    func getCategory(categoryId:String,competion: @escaping(CategoryResponse?) -> ()){
        print("offff",categoryId)
        
//        let request = NSMutableURLRequest(url: NSURL(string: "https://airbnb-search.p.rapidapi.com/property/search?query=New%20York%2C%20NY&category=\(categoryId)")! as URL,
//                                          cachePolicy: .useProtocolCachePolicy,
//                                          timeoutInterval: 10.0)
//        request.httpMethod = "GET"
//        request.allHTTPHeaderFields = headers
